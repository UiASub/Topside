...
def normalize_depth_payload(depth: dict) -> dict:
    return {
        ...
        "last_probe_addr": _coerce_json_number(_depth_val(depth, "last_probe_addr"), precision=0),
        "last_error": _coerce_json_number(_depth_val(depth, "last_error"), precision=0),
        "probe_error_0x76": _coerce_json_number(_depth_val(depth, "probe_error_0x76"), precision=0),
        "probe_error_0x77": _coerce_json_number(_depth_val(depth, "probe_error_0x77"), precision=0),
        "scl_idle": _coerce_json_number(_depth_val(depth, "scl_idle"), precision=0),
        "sda_idle": _coerce_json_number(_depth_val(depth, "sda_idle"), precision=0),
        "transport_error": _coerce_json_number(_depth_val(depth, "transport_error"), precision=0),
        "transport_mode": _coerce_json_number(_depth_val(depth, "transport_mode"), precision=0),
        "fw_depth_rev": _coerce_json_number(_depth_val(depth, "fw_depth_rev"), precision=0),
        "scan_count": _coerce_json_number(_depth_val(depth, "scan_count"), precision=0),
        "scan_first_addr": _coerce_json_number(_depth_val(depth, "scan_first_addr"), precision=0),
        "scan_last_addr": _coerce_json_number(_depth_val(depth, "scan_last_addr"), precision=0),
        "scan_has_0x76": _coerce_json_number(_depth_val(depth, "scan_has_0x76"), precision=0),
        "scan_has_0x77": _coerce_json_number(_depth_val(depth, "scan_has_0x77"), precision=0),
